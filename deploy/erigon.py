...
def download_and_install_erigon(eth_network, el_p2p_port, el_rpc_port, 
                                el_max_peer_count, jwtsecret_path,
                                cl_p2p_port, cl_rest_port, cl_max_peer_count,
                                sync_url, network_override=None, 
                                sync_parameters='', mev_parameters=''):
    ...
    service_content = generate_erigon_service(
        ...
        sync_url, network_override, sync_parameters, mev_parameters
    )
